 ...
 */
public class AspBlastCytometryNumericMeasureFilter extends LeoBaseAnnotator {
  ...
  public AspBlastCytometryNumericMeasureFilter setRegexFilePath(String regexFilePath) {
