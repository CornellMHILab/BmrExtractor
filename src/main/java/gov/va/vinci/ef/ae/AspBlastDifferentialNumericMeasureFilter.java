...
import gov.va.vinci.ef.types.AspBlastDifferentialNumericValue;
 ...
 */
public class AspBlastDifferentialNumericMeasureFilter extends LeoBaseAnnotator {
  ...
  public void annotate(JCas aJCas) throws AnalysisEngineProcessException {
    ...
    Collection<AspBlastDifferentialNumericValue> values = AnnotationLibrarian.getAllAnnotationsOfType(aJCas, AspBlastDifferentialNumericValue.type, false);
    for (AspBlastDifferentialNumericValue value : values) {    	
      try {
  ...
  public AspBlastDifferentialNumericMeasureFilter setRegexFilePath(String regexFilePath) {
