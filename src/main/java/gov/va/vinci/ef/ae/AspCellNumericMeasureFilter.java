...
import gov.va.vinci.ef.types.AspCellNumericValue;
 ...
 */
public class AspCellNumericMeasureFilter extends LeoBaseAnnotator {
  ...
  public void annotate(JCas aJCas) throws AnalysisEngineProcessException {
    ...
    /*Collection<gov.va.vinci.ef.types.CellMeasurement> terms = AnnotationLibrarian.getAllAnnotationsOfType(aJCas, gov.va.vinci.ef.types.CellMeasurement.type, false);
    for (gov.va.vinci.ef.types.CellMeasurement term : terms) {
    	System.out.println("Cellularity Measurement: " + term.getCoveredText());
    }*/
    
    Collection<AspCellNumericValue> values = AnnotationLibrarian.getAllAnnotationsOfType(aJCas, AspCellNumericValue.type, false);
    for (AspCellNumericValue value : values) {    	
      try {
  ...
  public AspCellNumericMeasureFilter setRegexFilePath(String regexFilePath) {
