...
import gov.va.vinci.ef.types.BxCellNumericValue;
 ...
 */
public class BxCellNumericMeasureFilter extends LeoBaseAnnotator {
  ...
  public void annotate(JCas aJCas) throws AnalysisEngineProcessException {
    ...
    Collection<BxCellNumericValue> values = AnnotationLibrarian.getAllAnnotationsOfType(aJCas, BxCellNumericValue.type, false);
    for (BxCellNumericValue value : values) {    	
      try {
  ...
  public BxCellNumericMeasureFilter setRegexFilePath(String regexFilePath) {
