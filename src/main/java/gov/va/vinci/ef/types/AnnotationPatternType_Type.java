...
public class AnnotationPatternType_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.ef.types.AnnotationPatternType");
  ...
  public int getAnchor(int addr) {
      ...
      jcas.throwFeatMissing("anchor", "gov.va.vinci.ef.types.AnnotationPatternType");
  ...
  public String getAnchorPattern(int addr) {
      ...
      jcas.throwFeatMissing("anchorPattern", "gov.va.vinci.ef.types.AnnotationPatternType");
  ...
  public String getPattern(int addr) {
      ...
      jcas.throwFeatMissing("pattern", "gov.va.vinci.ef.types.AnnotationPatternType");
  ...
  public int getTarget(int addr) {
      ...
      jcas.throwFeatMissing("target", "gov.va.vinci.ef.types.AnnotationPatternType");
  ...
  public String getTargetPattern(int addr) {
      ...
      jcas.throwFeatMissing("targetPattern", "gov.va.vinci.ef.types.AnnotationPatternType");
