 ...
 * @generated */
public class AspCellConcept extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(AspCellConcept.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected AspCellConcept() {/* intentionally empty block */}
   ...
   */
  public AspCellConcept(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public AspCellConcept(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public AspCellConcept(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
