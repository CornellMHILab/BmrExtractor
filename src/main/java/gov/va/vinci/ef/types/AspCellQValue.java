 ...
 * @generated */
public class AspCellQValue extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(AspCellQValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected AspCellQValue() {/* intentionally empty block */}
   ...
   */
  public AspCellQValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public AspCellQValue(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public AspCellQValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
