 ...
 * @generated */
public class BxBlast extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BxBlast.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BxBlast() {/* intentionally empty block */}
   ...
   */
  public BxBlast(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public BxBlast(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
