 ...
 * @generated */
public class BxBlastRelation extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BxBlastRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BxBlastRelation() {/* intentionally empty block */}
   ...
   */
  public BxBlastRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public BxBlastRelation(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public BxBlastRelation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
