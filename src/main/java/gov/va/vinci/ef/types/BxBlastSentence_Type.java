 ...
 * @generated */
public class BxBlastSentence_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (BxBlastSentence_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = BxBlastSentence_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new BxBlastSentence(addr, BxBlastSentence_Type.this);
  			   BxBlastSentence_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new BxBlastSentence(addr, BxBlastSentence_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = BxBlastSentence.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.ef.types.BxBlastSentence");
  ...
  public int getAnchor(int addr) {
      ...
      jcas.throwFeatMissing("Anchor", "gov.va.vinci.ef.types.BxBlastSentence");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public BxBlastSentence_Type(JCas jcas, Type casType) {
    super(jcas, casType);
