 ...
 * @generated */
public class BxBlastWindow extends Window {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BxBlastWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BxBlastWindow() {/* intentionally empty block */}
   ...
   */
  public BxBlastWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public BxBlastWindow(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public BxBlastWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
