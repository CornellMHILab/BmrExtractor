 ...
 * @generated */
public class BxCellConcept extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BxCellConcept.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BxCellConcept() {/* intentionally empty block */}
   ...
   */
  public BxCellConcept(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public BxCellConcept(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public BxCellConcept(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
