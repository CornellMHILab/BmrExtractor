 ...
 * @generated */
public class BxCellQValue extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BxCellQValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BxCellQValue() {/* intentionally empty block */}
   ...
   */
  public BxCellQValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public BxCellQValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
