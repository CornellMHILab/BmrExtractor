 ...
 * @generated */
public class BxFibConcept extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BxFibConcept.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BxFibConcept() {/* intentionally empty block */}
   ...
   */
  public BxFibConcept(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public BxFibConcept(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
