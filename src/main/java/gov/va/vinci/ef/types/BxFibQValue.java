 ...
 * @generated */
public class BxFibQValue extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BxFibQValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BxFibQValue() {/* intentionally empty block */}
   ...
   */
  public BxFibQValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public BxFibQValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
