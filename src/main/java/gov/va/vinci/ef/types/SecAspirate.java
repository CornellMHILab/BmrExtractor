 ...
 * @generated */
public class SecAspirate extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SecAspirate.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SecAspirate() {/* intentionally empty block */}
   ...
   */
  public SecAspirate(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public SecAspirate(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
