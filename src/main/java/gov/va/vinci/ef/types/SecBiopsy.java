 ...
 * @generated */
public class SecBiopsy extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SecBiopsy.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SecBiopsy() {/* intentionally empty block */}
   ...
   */
  public SecBiopsy(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public SecBiopsy(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
