 ...
 * @generated */
public class SecCytometry extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SecCytometry.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SecCytometry() {/* intentionally empty block */}
   ...
   */
  public SecCytometry(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public SecCytometry(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
