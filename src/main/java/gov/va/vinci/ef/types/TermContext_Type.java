...
public class TermContext_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (TermContext_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = TermContext_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new TermContext(addr, TermContext_Type.this);
  			   TermContext_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new TermContext(addr, TermContext_Type.this);
  	  }
    };
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.ef.types.TermContext");
  ...
  public String getExperiencer(int addr) {
      ...
      jcas.throwFeatMissing("Experiencer", "gov.va.vinci.ef.types.TermContext");
  ...
  public String getExperiencerPattern(int addr) {
      ...
      jcas.throwFeatMissing("ExperiencerPattern", "gov.va.vinci.ef.types.TermContext");
  ...
  public String getNegation(int addr) {
      ...
      jcas.throwFeatMissing("Negation", "gov.va.vinci.ef.types.TermContext");
  ...
  public String getNegationPattern(int addr) {
      ...
      jcas.throwFeatMissing("NegationPattern", "gov.va.vinci.ef.types.TermContext");
  ...
  public String getTemporality(int addr) {
      ...
      jcas.throwFeatMissing("Temporality", "gov.va.vinci.ef.types.TermContext");
  ...
  public String getTemporalityPattern(int addr) {
      ...
      jcas.throwFeatMissing("TemporalityPattern", "gov.va.vinci.ef.types.TermContext");
  ...
  public int getWindow(int addr) {
      ...
      jcas.throwFeatMissing("Window", "gov.va.vinci.ef.types.TermContext");
