 ...
 * @generated */
public class TextSegment extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(TextSegment.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TextSegment() {/* intentionally empty block */}
   ...
   */
  public TextSegment(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TextSegment(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
